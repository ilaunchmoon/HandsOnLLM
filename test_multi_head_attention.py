...
class TestMultiHeadAttention(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertIsInstance(self.attention.output_proj, nn.Linear)
        
        # 检查参数
        self.assertEqual(self.attention.head_num, self.head_num)
        self.assertEqual(self.attention.head_dim, self.hidden_dim // self.head_num)
    ...
    def test_masking(self):
        ...
        mask[:, :, :self.seq_len//2, :self.seq_len//2] = 0
